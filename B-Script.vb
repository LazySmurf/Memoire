...
Partial Class memoireForm
    Function DebuggingModeError()
        MessageBox.Show("A boolean variable checked neither true nor false." & vbNewLine & vbNewLine & "It is likely that a solar flare, cosmic ray, or resonance cascade has affected the performance of your computer." & vbNewLine & vbNewLine & "If you're unsure what this means, please contact your system administrator, IT support team, or local computer repair shop." & vbNewLine & vbNewLine & "This program will now terminate. We're sorry this error occurred.", " Anti-Mass Spectrometer Detected Cataclysmic Quantum Event")
        Return False
    End Function
    ...
    Function Holiday()
        ...
        If currentDate.Month = 12 AndAlso currentDate.Day = 25 Then
            LogText("Merry Christmas!")
            Return True
        End If
        If currentDate.Month = 7 AndAlso currentDate.Day = 1 Then
            LogText("Happy Canada Day!")
            Return True
        End If
        If currentDate.Month = 2 AndAlso currentDate.Day = 24 Then
            LogText("Happy Estonian Independence Day!")
            Return True
        End If
        If currentDate.Month = 12 AndAlso currentDate.Day = 31 Then
            LogText("Happy New Years Eve!")
            Return True
        End If
        If currentDate.Month = 1 AndAlso currentDate.Day = 1 Then
            LogText("Happy New Years Day!")
            Return True
        End If
        If currentDate.Month = 4 AndAlso currentDate.Day = 1 Then
            MessageBox.Show("Critical Application Error.", "Error A1-F")
            MessageBox.Show("April Fools!", "Just Kidding!")
            LogText("April Fools!")
            Return True
        End If
        If currentDate.Month = 4 AndAlso currentDate.Day = 15 Then
            LogText("Happy Birthday LazySmurf!")
            Return True
        End If
